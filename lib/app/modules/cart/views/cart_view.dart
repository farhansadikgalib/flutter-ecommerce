                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Dismissible(
                              ...
                              onDismissed: (direction) {
                                controller.allCartProducts.removeAt(index);
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: AnyImageView(
                                        ...
                                        boxFit: BoxFit.cover,
                                        imagePath:
                                            AppConfig.imageBasePath +
                                            product.flashProduct!.image!,
                                      ),
                                    ),
                                    SizedBox(width: 16.w),
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 4.h),
                                          Text(
                                            '${product.flashProduct!.selling} BDT',
                                            style: TextStyle(
                                              fontSize: 14.sp,
                                              color: AppColors.primaryColor,
                                            ),
...
/*  @override
  Widget body(BuildContext context) {
    return Obx(() {
      ...
      // Enhanced cart item list
      return RefreshIndicator(
        onRefresh: () async => controller.getCartItems(),
        child: ListView.builder(
          padding: REdgeInsets.symmetric(horizontal: 16, vertical: 12),
          itemCount: controller.allCartProducts.length,
          itemBuilder: (context, index) {
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: AnyImageView(
                        ...
                        imagePath: AppConfig.imageBasePath + product.flashProduct!.image!,
                      ),
                    ),
                    if (product.flashProduct!.id==1 ?? false)
                      Positioned(
                        top: 0,
                        left: 0,
                        child: Container(
